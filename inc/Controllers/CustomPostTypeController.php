...
use AcytMaster\Api\Callbacks\CptCallbacks; # cpt callbacks
use AcytMaster\Api\Callbacks\AdminCallbacks; # templates

/**
 * Register cpt and cpt page
 */
final class CustomPostTypeController extends BaseClass
{
  ...
  public function register() {
    ...
    // we can generate setting page also from this place
  ...
  // create settings for cpt - same as dashboard
  public function setSettings() {
    $args = array(
      array(
        'option_group' => 'acyt_plugin_cpt_settings',
        'option_name' => 'acyt_plugin_cpt',
  ...
  public function setFields() {
    $args = array(
      array(
        ...
        'page' => 'acyt_cpt',
        'section' => 'acyt_cpt_index',
        'args' => array( // optional args we can pass to callback
          'option_name' => 'acyt_plugin_cpt',
          'label_for' => 'post_type',
  ...
  /**
   * Store and prepare cpt for registration + default template
   *
   * @return void
   */
  public function storeCustomPostTypes() {
    $options = get_option('acyt_plugin_cpt', array() );
  ...
  /**
   * Register all user created post types in one loop
   *
   * @return void
   */
