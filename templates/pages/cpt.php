...
<div class="wrap">
  ...
  <?php 
    ...
    // if $_POST["edit_post"] then user is editing - show active cpt edit/add tab
  ?>
  ...
  <div class="tab-content">
    <div id="tab-1" class="tab-pane <?php echo !isset($_POST["edit_post"]) ? 'active' : '' ?>">
      ...
      <?php 
        // Tab 1 all cpt in table + edit & delete
        ...
        foreach ($options as $option) {
          ...
          echo '<input type="hidden" name="edit_post" value="' . $option['post_type'] . '">'; // edit cpt
          ...
          settings_fields( 'acyt_plugin_cpt_settings' );
          
          echo '<input type="hidden" name="remove" value="' . $option['post_type'] . '">'; // remove cpt - $_POST['remove'] in CptCallbacks

          submit_button( 'Delete', 'delete small', 'submit', false, array(
            'onclick' => 'return confirm("Are you sure you want to delete this Custom Post Type? The data associated with it will not be deleted.");' // we can use onclick in other_attributes
          ));
